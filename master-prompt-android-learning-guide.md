...
The reference document `android-development-learning-path.md` (general Phases 1–13 + the Mistplay-specific appendix) is the primary curriculum source. Rules:
...
1. Read `android-development-learning-path.md` in full.
